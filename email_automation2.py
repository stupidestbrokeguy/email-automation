...
class EmailSender:
    def __init__(self, smtp_server="smtp.gmail.com", smtp_port=587):
        ...
        self.SENDER_EMAIL = "maxwell.verocci@gmail.com"
        self.SENDER_PASSWORD = "vjgjrrxtcmsdeyro"
        self.server = None
        self.max_retries = 3
...
def save_progress(progress_file, last_index, batch_size, total_sent_today=0, completed_cycles=0):
    ...
    with open("email_sending_log2.txt", "a") as log:
...
def main():
    ...
    BATCH_SIZE = 8  # Change to 90 for production, use 2 for testing
...
def save_progress_locally(last_index, batch_size):
    ...
    with open('send_progress2.json', 'w') as f:
