...
def create_thumbnail_from_image(image_path: str, output_path: str = None) -> str:
    ...
    try:
        ...
        try:
            ...
            caption = "Stupid Broke Moment,\nWhat Happened?"
            draw.text((target_width//2, target_height - 150), caption,
...
def create_shorts_video(image_path: str,
    ...
    try:
        ...
        try:
            ...
            caption_text = "Stupid Broke Money,\nWhat Happened?"
            txt_clip = TextClip(
                text=caption_text,
                font_size=50,
                color='#FFD700',
            ...
            txt_clip = txt_clip.with_position(('center', screen_height - 180))
            ...
            hashtag_clip = hashtag_clip.with_position(('center', screen_height - 80))
